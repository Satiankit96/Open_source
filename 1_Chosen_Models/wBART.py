...
class BARTSummarizer:
    ...
    def summarize_chunks(self, chunks: list, combined_prompt: str = "", max_length: int = 350, min_length: int = 150) -> str:
        """
    ...
    def summarize_text(self, text: str, combined_prompt: str = "", max_length: int = 350, min_length: int = 150) -> str:
        """
...
"""
    ...
    try:
        ...
        combined_prompt = (
            "Provide a comprehensive summary covering the outlook of China's economy, "
            "China's economic impact on the US, and China's impact on banks."
        )
